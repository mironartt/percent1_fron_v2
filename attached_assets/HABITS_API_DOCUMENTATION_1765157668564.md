...
**Endpoint:** `POST /api/rest/front/app/habits/settings/get/`
...
**Endpoint:** `POST /api/rest/front/app/habits/settings/update/`
...
**Endpoint:** `POST /api/rest/front/app/habits/get/`
...
**Endpoint:** `POST /api/rest/front/app/habits/update/`
...
**Endpoint:** `POST /api/rest/front/app/habits/completions/update/`
...
**Endpoint:** `POST /api/rest/front/app/habits/amnesty/apply/`
...
**Endpoint:** `POST /api/rest/front/app/habits/amnesty/revoke/`
...
**Endpoint:** `POST /api/rest/front/app/habits/analytics/get/`
...
**Endpoint:** `POST /api/rest/front/app/habits/achievements/get/`
...
**Endpoint:** `POST /api/rest/front/app/habits/stats-panel/`
...
**Endpoint:** `POST /api/rest/front/app/habits/recommended/`
...
**Endpoint:** `POST /api/rest/front/app/habits/xp/history/`
...
**Endpoint:** `POST /api/rest/front/app/habits/xp/stats/`
...
**Endpoint:** `POST /api/rest/front/app/habits/rewards/get/`
...
**Endpoint:** `POST /api/rest/front/app/habits/rewards/create/`
...
**Endpoint:** `POST /api/rest/front/app/habits/rewards/redeem/`
...
**Endpoint:** `POST /api/rest/front/app/habits/rewards/update/`
...
**Endpoint:** `POST /api/rest/front/app/habits/rewards/delete/`
