<template>
  <div class="ssp-container">
    ...
    <div v-if="currentStep === 1" class="step-content">
      <div class="theory-section">
        ...
        <div class="card theory-content">
          <h2>Ключевая идея модуля</h2>
          <div class="idea-block">
            <div class="idea-icon">💡</div>
            <div>
              <h3>Цели работают только тогда, когда опираются на внутреннюю мотивацию и системное равновесие</h3>
              <p>Для роста нужен баланс. Дисбаланс в жизни создает внутренние конфликты, которые мешают достигать целей.</p>
            </div>
          </div>

          <div class="belief-transformation">
            <div class="old-belief">
              <h4>❌ Ограничивающее убеждение:</h4>
              <ul>
                <li>"Дисбаланс мне не мешает"</li>
                <li>"Не важно, чего я хочу, важно разобраться с делами"</li>
              </ul>
            </div>
            <div class="arrow">→</div>
            <div class="new-belief">
              <h4>✅ Новое убеждение:</h4>
              <ul>
                <li>"Баланс дает мне энергию для роста"</li>
                <li>"Мои истинные желания — это компас для развития"</li>
              </ul>
            </div>
          </div>

          <div class="journey-vision">
            <h3>Что даст вам этот модуль</h3>
            <div class="benefits-grid">
              <div class="benefit-item">
                <span class="benefit-icon">🎯</span>
                <div>
                  <h4>Ясность целей</h4>
                  <p>Поймете, какие цели действительно ваши, а не навязанные</p>
                </div>
              </div>
              <div class="benefit-item">
                <span class="benefit-icon">⚖️</span>
                <div>
                  <h4>Системный взгляд</h4>
                  <p>Увидите жизнь целиком, а не отдельные проблемы</p>
                </div>
              </div>
              <div class="benefit-item">
                <span class="benefit-icon">🚀</span>
                <div>
                  <h4>Фокус на главном</h4>
                  <p>Выберете 3-5 целей, которые дадут максимальный результат</p>
                </div>
              </div>
              <div class="benefit-item">
                <span class="benefit-icon">💪</span>
                <div>
                  <h4>Энергия для действий</h4>
                  <p>Почувствуете мотивацию, основанную на внутренних ценностях</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <!-- AI Curator (always visible) -->
    <AICurator v-if="currentStep >= 2" />
  </div>
</template>
