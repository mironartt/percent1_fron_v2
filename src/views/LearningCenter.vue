...
const lessons = [
  ...
  },
  {
    ...
    description: 'Методология SMART и техника «Три Почему»',
    duration: 8,
    icon: markRaw(Target),
    color: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)',
    locked: false,
    content: `
      <h3>Искусство ставить цели</h3>
      <p>Правильно поставленная цель — половина успеха.</p>
      ...
      <ul>
        ...
        <li><strong>T</strong>ime-bound — Ограниченная по времени</li>
      </ul>
      
      <h4>Техника «Три Почему»</h4>
      <p>Задайте себе вопрос «Почему?» три раза, чтобы найти истинную мотивацию:</p>
      <ol>
        <li>Почему я хочу эту цель?</li>
        <li>Почему это важно для меня?</li>
        <li>Почему это изменит мою жизнь?</li>
      </ol>
      
      <h4>Пример</h4>
      <p><strong>Цель:</strong> Выучить английский до уровня B2 за 6 месяцев</p>
      <p><strong>Почему?</strong> Чтобы получить повышение → Чтобы зарабатывать больше → Чтобы обеспечить лучшую жизнь семье</p>
    `
  },
  {
    id: 'decomposition',
