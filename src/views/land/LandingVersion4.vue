      ...
      <div class="container">
        ...
        <div class="block-content">
          <div class="block-text">
            ...
            <p class="block-subtitle">4 сообщения в день: утром мотивирует, днём напоминает, вечером анализирует.</p>
                  ...
                  <div class="telegram-chat">
                    ...
                    <div class="tg-messages">
                      ...
                      <div class="tg-message ai">
                        <div class="tg-bubble">
                          За 2 недели обновил резюме и прошёл курс — это подготовка. Но резюме так и не отправлено ни в одну компанию.
                        </div>
                        <div class="tg-time">10:33</div>
                      </div>
                      <div class="tg-message ai">
                        <div class="tg-bubble">
                          Работу находят не через подготовку, а через отклики. Даже с несовершенным резюме.
                        </div>
                        <div class="tg-time">10:33</div>
                      </div>
                      <div class="tg-message ai">
                        <div class="tg-bubble">
                          Что мешает отправить хотя бы 3 резюме сегодня? Страшно, что ответят? Или кажется, что резюме ещё не идеально?
                        </div>
                        <div class="tg-time">10:34</div>
                      </div>
                    </div>
                  </div>
                </div>
