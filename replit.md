...
-   **Landing Version 5 (/land/version5)**: Combined version with version4's 5-step user journey plus main landing's trust-building elements: hero with animated compound growth chart, header with login/register, "Проверено временем" legends section (Franklin, Clear, Buffett, da Vinci), dynamic pricing section with term selector, and enhanced footer with legal links and company info.
