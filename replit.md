...
**Mobile Navigation (Remente-style)**: Bottom navigation with centered FAB button. Structure: Главная - Цели - [FAB] - План - Ещё. The FAB is a raised circular button with orange gradient, containing quick actions for tasks, goals, journal, habits, and AI mentor.
